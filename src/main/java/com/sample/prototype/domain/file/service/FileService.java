package com.sample.prototype.domain.file.service;

import com.sample.prototype.domain.file.model.dto.FileResponseDTO;
...
import com.sample.prototype.domain.file.repository.FileRepository;
...
public class FileService {
	...
	public FileService(FileRepository fileRepository,
					   @Value("${file.upload-dir:${user.home}/prototype-uploads}") String uploadDir) {
