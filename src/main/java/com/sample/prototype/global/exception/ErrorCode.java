package com.sample.prototype.global.exception;
...
public enum ErrorCode {
	...
	USER_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER_002", "이미 존재하는 사용자 이름입니다."),
	USER_EMAIL_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER_003", "이미 존재하는 이메일입니다."),
	USER_INVALID_CREDENTIALS(HttpStatus.UNAUTHORIZED, "USER_004", "사용자 이름 또는 비밀번호가 잘못되었습니다."),
